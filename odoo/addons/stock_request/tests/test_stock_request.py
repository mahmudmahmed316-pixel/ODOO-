...
class TestStockRequestBase(TestStockRequest):
    ...
    def test_create_request_01(self):
        ...
        self.assertEqual(stock_request.quantity, 0.0)
        ...
        self.assertEqual(stock_request.quantity, stock_request.product_uom_qty)
    ...
    def test_create_request_03(self):
        ...
        self.assertEqual(stock_request_1.quantity, 4)
        self.assertEqual(stock_request_1.qty_cancelled, 0)
